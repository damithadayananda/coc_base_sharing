  ...
  return (
    <ScrollView>
      <DataTable.Row style={styles.row}>
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 14})}>
          <Card>
            <Card.Cover
        ...
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 13})}>
          <Card>
            <Card.Cover
      ...
      <DataTable.Row style={styles.row}>
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 12})}>
          <Card>
            <Card.Cover
        ...
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 11})}>
          <Card>
            <Card.Cover
      ...
      <DataTable.Row style={styles.row}>
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 10})}>
          <Card>
            <Card.Cover
        ...
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 9})}>
          <Card>
            <Card.Cover
      ...
      <DataTable.Row style={styles.row}>
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 8})}>
          <Card>
            <Card.Cover
        ...
        <DataTable.Cell
          style={styles.card}
          onPress={() => navigation.navigate('HomeMap', {th: 7})}>
          <Card>
            <Card.Cover
